#%%
from helpers import get_truncnorm_sample, plot_truncnorm_pdf, sample_ba_hist
...
#%%
ba = galaxies["ba"].values
hist = np.histogram(ba, 100, (0, 1), density=True)[0]

i = [0.4, 0.001, 0.1, 0.1]
N = 10000
ba_samples = sample_ba_hist(hist, N)
...
len(cos_t_samples[np.isnan(cos_t_samples)])
